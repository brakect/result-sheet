...
if(isset($_POST['ok'])){
	...
	if(in_array($_POST['unam'], $usr)){
		...
		echo $url='<a href="http://localhost/JAHIDUL_ISLAM/16-01-2020/Student_result/get_code.php?code='.$rand.'">http://localhost/JAHIDUL_ISLAM/16-01-2020/Student_result/get_code.php?code='.$rand.'</a>';
